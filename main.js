...
conn.sendMessage(`666666666718@s.whatsapp.net`, {text: `CONNECTED SUCCESSFULLY`})
success(`1`,`[■■■■■■■■■■■■■■■] Connected`) 
}
}
...
Location: ${data.Infogempa.gempa.Wilayah}
Potential: ${data.Infogempa.gempa.Potensi}
Effect: ${data.Infogempa.gempa.Dirasakan}

Note:
To disable the automatic earthquake update feature, please type .updategempa off
`
...
console.log("disabling earthquake auto-update in the group")
} else {
await sleep(3000)
...
if(!anus.includes(i)) {
gempa.splice(gempa.indexOf(i,1)) 
console.log("remove auto update earthquake on group")
} else {
await sleep(3000)
conn.sendMessage(i,{image,caption}) 
}
